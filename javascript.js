    ...
    function guessingGameTwo () {
        let soccerTeams = ['Real Salt Lake ', ' Barcelona ', ' Liverpool ', ' Chelsea ', ' FC Bayern Munic ', ' Southampton ', ' Millwall ', ' Sunderland ', ' Manchester United ', ' Manchester City ' , ' LA Galaxy ', ' Seattle Sounders ', ' BVB ', ' Valencia ', ' Real Madrid '];
